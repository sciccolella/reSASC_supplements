...
parser.add_argument('--mgroundT', action='store', type=str, nargs='+', required=True,
                    help='path of the grounds TRUE [MATRICES]')
parser.add_argument('--mgroundN', action='store', type=str, nargs='+', required=True,
                    help='path of the grounds NOISY [MATRICES]')
parser.add_argument('--mtools', action='append', type=str, nargs='+', required=True,
